...
<template>
    ...
    <form @submit.prevent="submit" class="space-y-4">
        ...
        <div><label class="block text-sm font-medium text-secondary">Stock Actual</label><input v-model="form.stock_actual" type="number" step="1" required class="mt-1 w-full theme-input" /></div>
