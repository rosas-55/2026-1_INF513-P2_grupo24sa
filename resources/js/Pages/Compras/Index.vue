...
const form = useForm({});
function destroy(id) { if (confirm('Â¿Eliminar esta compra?')) form.delete(route('compras.destroy', id)); }
</script>
<template>
