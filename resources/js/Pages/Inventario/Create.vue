...
const form = useForm({ insumo_id: '', cantidad: 1, tipo_movimiento: 'ENTRADA', observacion: '', costo_unitario: 0, fecha: '' });
...
<template>
    ...
    <form @submit.prevent="submit" class="space-y-4">
        ...
        <div><label class="block text-sm font-medium text-secondary">Cantidad</label><input v-model="form.cantidad" type="number" step="1" required class="mt-1 w-full theme-input" /></div>
