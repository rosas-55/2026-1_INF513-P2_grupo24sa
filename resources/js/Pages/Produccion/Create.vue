...
const form = useForm({ receta_id: '', cantidad_producida: 1, fecha: '' });
...
<template>
    ...
    <form @submit.prevent="submit" class="space-y-4">
        ...
        <div><label class="block text-sm font-medium text-secondary">Cantidad a Producir</label><input v-model="form.cantidad_producida" type="number" step="1" required class="mt-1 w-full theme-input" /></div>
