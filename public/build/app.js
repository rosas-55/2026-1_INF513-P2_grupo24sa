...
createInertiaApp({
	...
	resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* #__PURE__ */ Object.assign({
		"./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-DA6Pe7Pj.js"),
		"./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-CEfTM1w0.js"),
		"./Pages/Auth/Login.vue": () => import("./assets/Login-BhRwuDlu.js"),
		"./Pages/Auth/Register.vue": () => import("./assets/Register-CFH8g5eB.js"),
		"./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-ChdgapNt.js"),
		"./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-DdRaE4WC.js"),
		"./Pages/Bitacora/Index.vue": () => import("./assets/Index-D986NTTS.js"),
		"./Pages/Compras/Create.vue": () => import("./assets/Create-DNwyhNsg.js"),
		"./Pages/Compras/Index.vue": () => import("./assets/Index-BxOcWjQo.js"),
		"./Pages/Compras/Show.vue": () => import("./assets/Show-DEIKWciv.js"),
		"./Pages/Cuotas/Index.vue": () => import("./assets/Index-DzVLuJU0.js"),
		"./Pages/Dashboard.vue": () => import("./assets/Dashboard-LWhokXdg.js"),
		"./Pages/Insumos/Create.vue": () => import("./assets/Create-CGdlXcPi.js"),
		"./Pages/Insumos/Edit.vue": () => import("./assets/Edit-B4OXLaLw.js"),
		"./Pages/Insumos/Index.vue": () => import("./assets/Index-sr8zE8-1.js"),
		"./Pages/Inventario/Create.vue": () => import("./assets/Create-BrFNUQob.js"),
		"./Pages/Inventario/Index.vue": () => import("./assets/Index-mOXua5nk.js"),
		"./Pages/Produccion/Create.vue": () => import("./assets/Create-B19oU0vC.js"),
		"./Pages/Produccion/Index.vue": () => import("./assets/Index-Cj10OaJa.js"),
		"./Pages/Productos/Create.vue": () => import("./assets/Create-DNX_tskz.js"),
		"./Pages/Productos/Edit.vue": () => import("./assets/Edit-sWNtVIel.js"),
		"./Pages/Productos/Index.vue": () => import("./assets/Index-Cz7_nUNc.js"),
		"./Pages/Profile/Edit.vue": () => import("./assets/Edit-PbISO_o6.js"),
		"./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-BGBLKwF1.js"),
		"./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-C-z7oWnb.js"),
		"./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-Dc_Hfu46.js"),
		"./Pages/Proveedores/Create.vue": () => import("./assets/Create-CplEsxov.js"),
		"./Pages/Proveedores/Edit.vue": () => import("./assets/Edit-CIkpGiRq.js"),
		"./Pages/Proveedores/Index.vue": () => import("./assets/Index-CTRRK4ID.js"),
		"./Pages/Recetas/Create.vue": () => import("./assets/Create-lBh8g0Dh.js"),
		"./Pages/Recetas/Edit.vue": () => import("./assets/Edit-DFJ8I0xg.js"),
		"./Pages/Recetas/Index.vue": () => import("./assets/Index-UN9ku4xg.js"),
		"./Pages/Reportes/Index.vue": () => import("./assets/Index-CA1f47O42.js"),
		"./Pages/Seguridad/Index.vue": () => import("./assets/Index-Deub8wo0.js"),
		"./Pages/Ventas/Create.vue": () => import("./assets/Create-Dmoki6PG.js"),
		"./Pages/Ventas/Index.vue": () => import("./assets/Index-V7N5Z8xd.js"),
		"./Pages/Ventas/Show.vue": () => import("./assets/Show-B-fotGhS.js"),
		"./Pages/Welcome.vue": () => import("./assets/Welcome-Cfrki-DF.js")
	})),
	setup({ el, App, props, plugin }) {
		return createApp({ render: () => h(App, props) }).use(plugin).use(M).mount(el);
	},
